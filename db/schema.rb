...
ActiveRecord::Schema.define(:version => 20120916230028) do
  ...
  create_table "flashing_dots_tests", :force => true do |t|
    t.integer  "user_id"
    t.integer  "level"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  add_index "flashing_dots_tests", ["user_id"], :name => "index_flashing_dots_tests_on_user_id"
